...
# This file auto generated from Data/common/main/ta.xml
	...
	default		=> sub { {
		...
		'TMT' => {
			...
			display_name => {
				...
				'one' => q(துர்க்மெனிஸ்தானி மனத்),
				'other' => q(துர்க்மெனிஸ்தானி மனத்),
			},
		},
		'TND' => {
			symbol => 'TND',
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Norfolk' => {
			long => {
				'standard' => q#நார்ஃபோக் தீவு நேரம்#,
			},
		},
		'Noronha' => {
			long => {
